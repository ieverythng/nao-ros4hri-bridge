...
ros2 pkg list | grep -E "(asr_vosk|chatbot_llm|dialogue_manager|interaction_skills|naoqi|nao_(chatbot|look_at|orchestrator|replay_motion|say_skill|scene_grounding|skills|world_model_enricher)|planner_(common|llm)|simple_audio_capture|emorobcare_cv_(msgs|object_detection)|my_game_interface)" || \

...
DEFAULT_SYSTEM_PROMPT = (
    ...
    'prefer scan/find_object/report_result skill semantics from the supplied registry '
    'instead of inventing robot-specific sweep choreography. Include the requested target '
    'or target_kind in args; if the target is ambiguous, clarify before planning. '

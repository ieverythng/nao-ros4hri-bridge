...
DEFAULT_SYSTEM_PROMPT = (
    ...
    'For report_result immediately after scan or another perception skill, omit '
    'summary_text so the executor reuses the latest live skill result; never prefill '
    'a perceptual summary from grounded_context. Only provide summary_text for a known '
    'non-perception fact or an already completed non-perception result. Never emit '

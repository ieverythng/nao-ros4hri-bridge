#!/usr/bin/env python3
"""Prompt builders for response and intent stages."""
...
def build_response_prompt(
    ...
    """Build system prompt used for stage-1 verbal response generation."""
...
def build_intent_prompt(
    ...
    """Build system prompt used for stage-2 intent extraction."""
    return _join_prompt_parts(
        persona_prompt,
        _safe_format(system_prompt, robot_name=robot_name, user_id=user_id),

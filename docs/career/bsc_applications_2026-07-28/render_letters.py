#!/usr/bin/env python3
"""Render the editable BSC motivation letters as compact A4 PDFs."""
...
OUTPUT = ROOT / "pdf"
SOURCES = sorted(ROOT.glob("[0-9][1-5]_*.md"))
...
def render(source: Path) -> Path:
    ...
    doc = BaseDocTemplate(
        ...
        subject="Motivation letter for the Barcelona Supercomputing Center",
    )
    frame = Frame(
        doc.leftMargin,
        doc.bottomMargin,

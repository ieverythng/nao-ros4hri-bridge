...
\code{planner_llm}: structured skill-plan generation, goal supervision, replanning decisions, dialogue-act intent};
...
\draw[control]
  ...
  node[label, left]{execution feedback / supervision}
...
{9. \code{planner_llm}: supervise result, replan, or request communication};

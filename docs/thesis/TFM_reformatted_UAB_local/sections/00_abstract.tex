...
The expected contribution is a reusable and inspectable planning framework for grounded human-robot interaction, together with an empirical evaluation of its robustness, modularity, and limitations. The thesis will compare direct execution against planner-mediated execution and analyse how skill contracts, execution feedback, and grounded context influence task completion, replanning, and interaction quality.

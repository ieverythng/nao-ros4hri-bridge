...
& KnowledgeCore statements through \code{/kb/query} and \code{/kb/revise}; source evidence includes ROS4HRI person state, \code{/scene/summary}, and skill results.

...
% ============================================================
% UAB MSc Thesis, ROS4HRI / LLM Planner Architecture
% ============================================================
...
\hrule
\vspace{0.9cm}
{\LARGE Implementation and Validation of an LLM-Based Planner for Modular ROS4HRI Robotic Systems}\\[8mm]
\hrule
\vspace{18mm}
...
\input{sections/04_runtime_contracts}
